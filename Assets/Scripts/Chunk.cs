        ...
        for (int z = 0; z < World.chunkSize; z++)
            for (int y = 0; y < World.chunkSize; y++)
                for (int x = 0; x < World.chunkSize; x++)
                {
                    ...
                    //CAVE SPAWNING
                    else if (Utils.fBM3D(worldX, worldY, worldZ, 0.01f, 3) < 0.41f)
                    ...
                    else if (worldY <= Utils.GenerateStoneHeight(worldX, worldZ))
                    {
                        ...
                        //DIAMOND SPAWNING
                        if (Utils.fBM3D(worldX, worldY, worldZ, 0.01f, 2) < 0.1f * (3.92f / diamondChance))
                        {
                        ...
                        else if (Utils.fBM3D(worldX, worldY, worldZ, 0.03f, 4) < 0.32f && worldY <= 16)
                        {
